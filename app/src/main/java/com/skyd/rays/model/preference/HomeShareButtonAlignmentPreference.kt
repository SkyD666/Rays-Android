...
object HomeShareButtonAlignmentPreference : BasePreference<BiasAlignment> {
    private const val HOME_SHARE_BUTTON_ALIGNMENT = "homeShareButtonAlignment"
    override val default = BiasAlignment(1f, -1f)
    ...
    override fun fromPreferences(preferences: Preferences): BiasAlignment {
